...
namespace WebSuiBeauty.Areas
{
    public class ProductCategoriesAdminController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Alias,Description,ParentId,DisplayOrder,Image,HomeFlag,CreatedDate,CreatedBy,ModifiedDate,ModifiedBy,MetaKeywords,MetaDescriptions,Status")] ProductCategory productCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Alias,Description,ParentId,DisplayOrder,Image,HomeFlag,CreatedDate,CreatedBy,ModifiedDate,ModifiedBy,MetaKeywords,MetaDescriptions,Status")] ProductCategory productCategory)
        {
            if (ModelState.IsValid)
            {
